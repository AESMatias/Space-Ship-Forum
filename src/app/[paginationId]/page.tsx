            ...
            <div className="flex flex-col md:flex-row justify-center items-center w-full">
                <div className="flex flex-col w-8/12 pb-10">
                    <section className="text-center m-1 gap-2 py-10">
                        ...
                        {characters.length > 0 ? (
                            <>
                                <CustomDrawer isHome={false} data={characters[13]} />
                                <CustomDrawer isHome={false} data={characters[6]} />
                                <CustomDrawer isHome={false} data={characters[15]} />
                                <CustomDrawer isHome={false} data={characters[17]} />
                                <CustomDrawer isHome={false} data={characters[1]} />
                                <CustomDrawer isHome={false} data={characters[18]} />
                            </>
                        ) :
                            (
